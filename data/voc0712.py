...
<<<<<<< HEAD
            ...
            bbox = obj.find('bounding_box')

            pts = ['x_left_top', 'y_left_top', 'width', 'height']
            #print(bbox)
            bndbox = [1,2,3,4]
            temp_bndbox = []
            for i, pt in enumerate(pts):
                cur_pt = int(bbox.find(pt).text)# - 1
                temp_bndbox.append(cur_pt)
                # scale height or width
                #cur_pt = cur_pt / width if i % 2 == 0 else cur_pt / height
            #temp_bndbox ['x_left_top', 'y_left_top', 'width', 'height']
            #bndbox ['xmin','ymin','xmax','ymax']
            bndbox[0]=temp_bndbox[0]
...
<<<<<<< HEAD
        ...
        print(apss)
        #f3 =open("/home/sqy/Program/competition/Tank_Det/result_RFB.txt","w")
